...
const Client = ({ username,userState,initial }) => {
  ...
  return (
    <div className="flex border-accent  active-bg items-center space-x-3 p-3 bg-tertiary rounded-lg border border-primary hover:hover-bg transition-all duration-200">
